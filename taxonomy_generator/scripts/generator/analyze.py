...
from taxonomy_generator.utils.utils import compare_datas
...
def get_num_topics():
    ...
    total = sum(num_topics.values())

    return {k: v / total * 100 for k, v in num_topics.items()}


def plot_attempt_num_topics():
    all_num_topics = []
...
def compare_num_topics():
    ...
    attempt_num_topics = plot_attempt_num_topics()
